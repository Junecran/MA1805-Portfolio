...
- Collision help - https://how.dev/answers/p5js-collision-detection
...
- Animating the walking people - https://editor.p5js.org/codingtrain/sketches/vhnFx1mml, 

- Number manipulation like floor() - https://p5js.org/reference/#Calculation

- Combining 'if' statements - https://sentry.io/answers/how-do-i-use-and-in-if-statements-in-java/#:~:text=In%20Java%2C%20we%20can%20use,evaluate%20multiple%20conditions%20at%20once.

- A bit more info on loops , helped with 'break' - https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Loops_and_iteration

- Loop replaying after hiting '0' - https://stackoverflow.com/questions/43897942/javascript-restart-loop-once-at-the-end-of-an-array

### Info

- **floor()** - Calculates the closest integer value that is less than or equal to the value of a number.

- **return()** - Creating a 'new object' and sends that object out of the function so it can be used elsewhere. - could be used instead of push and pop ?

- **&&** - Operator is used when all conditions need to be true.

- **-=** - Shorthand for taking away the original value.